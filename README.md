...
- GitHub Actions должен содержать repository secret `INDEXNOW_KEY`: стабильную строку из 8–128 латинских букв, цифр и дефисов, кроме зарезервированного имени `llms-full`. Deploy публикует её как корневой IndexNow key-файл и после синхронизации отправляет только изменённые канонические URL
