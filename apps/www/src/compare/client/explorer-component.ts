import { flushSync, hydrate as hydrateComponent, unmount as unmountComponent } from 'svelte';
...
export const hydrate = (target: HTMLElement, payload: ExplorerPayload): ExplorerInstance => {
