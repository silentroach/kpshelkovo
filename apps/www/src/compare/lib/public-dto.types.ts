...
export type ComparePublicPayload = DeepReadonly<z.output<typeof ComparePublicPayloadSchema>>;
export type ComparePublicSettlement = ComparePublicPayload['settlements'][number];
