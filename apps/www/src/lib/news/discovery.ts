    ...
    paths: {
      [articlesDataPath()]: {
        get: {
          ...
          description:
            'Возвращает полную ленту новостей с body_markdown, тегами и архивами. Календарные объекты внутри статьи содержат только события с точным временем начала; отмена и условный набор указаны в description. Все события, включая даты без часов и многодневные периоды, доступны в /events/events.json со связями по публичным URL новостей.',
          responses: {
            200: {
