        ...
        sections: [
          ...
          llmsSection('Описание people.json', [
            markdownList([
              ...
              '`backlinks` группируются по `news`, `status`, `reviews`, `places`, `people`, `contacts` и `discomfort`, чтобы отвечать на вопрос, где человек уже фигурирует на сайте; граф учитывает канонические и подписанные упоминания.',
            ]),
          ]),
