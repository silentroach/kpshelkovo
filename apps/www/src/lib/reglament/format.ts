...
export const formatReglamentInputNumber = createNumberFormatterRu(INPUT_NUMBER_OPTIONS);

export const parseReglamentNumberInput = (value: number | string): number | undefined =>
  parseNumberInputRu(value);

export const formatReglamentSignedNumber = createNumberFormatterRu(SIGNED_MONEY_OPTIONS);
...
export const formatReglamentTariffValue = (value: number): string => formatReglamentMoney(value);
