...
const projectCoefficients = (coefficients: EstimateCoefficients): EstimateCoefficients => ({
...
export const projectEstimateCalculationInput = (estimate: Estimate): EstimateCalculationInput => ({
