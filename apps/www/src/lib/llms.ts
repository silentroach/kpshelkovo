        ...
        sections: [
          ...
          llmsSection('Как ориентироваться', [
            markdownList([
              ...
              `Карта мест: ${placesMarkdown}; карточки: \`/places/[slug]/\` и \`/places/[slug]/index.md\`.`,
        ...
        sections: [
          ...
          llmsSection('Карта мест', [
            markdownList([
              ...
              'Карточки мест используют `/places/[slug]/` и `/places/[slug]/index.md`.',
          ...
          llmsSection('Как выбирать источник', [
            markdownList([
              ...
              'Для карты начинайте с `/places/index.md`; одно место открывается через `/places/[slug]/` или `/places/[slug]/index.md`.',
