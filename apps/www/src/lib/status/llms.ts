        ...
        sections: [
          ...
          llmsSection('HTML и Markdown', [
            markdownList([
              ...
              'Страницы сервисов `/status/[service]/` и их Markdown-версии `/status/[service]/index.md` удобны для фокусного чтения одной линии: электричество, вода, интернет, дамба или дороги.',
