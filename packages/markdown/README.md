...
- `formatPlainText(text)`
  Типографирует обычную строку без разбора HTML, entity-последовательностей и Markdown. Результат — текст для безопасного вывода через `textContent`, а не HTML.
